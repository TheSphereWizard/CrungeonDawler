...
//	public void keyTyped(KeyEvent e) { }
    ...
    private void newGame(){
        ...
        game=new Game(new Player("Test Player",new Actor("testSpriteSheetforActors2",Game.pixelTileWidth,Game.pixelTileWidth)));//Umm players will need some sort of menu to pick from, Or at the very least a feild for Name
